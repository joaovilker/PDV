...
CREATE TABLE `abertura_caixa` (
  ...
  `status_caixa` int(1) DEFAULT NULL,
  `saldo_inicial` double(10,2) DEFAULT NULL,
  `aberto_por` int(11) DEFAULT NULL,
  `fechado_por` int(11) NOT NULL,
  `data_fechamento` date NOT NULL,
  `hora_fechamento` time NOT NULL,
  `total_caixa` double(10,2) NOT NULL,
  `retirada` double(10,2) NOT NULL,
  `saldo_restante` double(10,2) NOT NULL
...
CREATE TABLE `fechamento_caixa` (
  ...
  `saldo_final` double(10,2) DEFAULT NULL,
  `vendedor` int(11) DEFAULT NULL,
  `caixa_aberto` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `nivel_acesso` (
  ...
  `nome_nivel` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `produtos` (`id_produto`, `produto`, `quantidade_minima`, `quantidade_estoque`, `valor_compra`, `valor_venda`, `fornecedor`, `tipo`, `obs`) VALUES
...
--
-- Estrutura da tabela `status_usuarios`
--
...
--
-- Extraindo dados da tabela `status_usuarios`
--
...
INSERT INTO `tarefas` (`id_tarefa`, `para`, `data_aviso`, `data_tarefa`, `tarefa`, `status`) VALUES
(1, 1, '2018-01-20', '2018-01-25', 'Testando a tarefa!', 1);
...
--
-- Indexes for table `fechamento_caixa`
--
ALTER TABLE `fechamento_caixa`
  ADD PRIMARY KEY (`id_caixa`),
  ADD KEY `fk_fechamento_caixa_1_idx` (`caixa_aberto`);
...
--
ALTER TABLE `tarefas`
  ADD UNIQUE KEY `id_tarefa` (`id_tarefa`);
...
ALTER TABLE `vendas`
  ...
  ADD KEY `fk_vendas_1_idx` (`id_caixa`),
  ADD KEY `fk_vendas_2_idx` (`cod_produto`);
...
--
-- AUTO_INCREMENT for table `fechamento_caixa`
--
ALTER TABLE `fechamento_caixa`
  MODIFY `id_caixa` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Limitadores para a tabela `fechamento_caixa`
--
ALTER TABLE `fechamento_caixa`
  ADD CONSTRAINT `fk_fechamento_caixa_1` FOREIGN KEY (`caixa_aberto`) REFERENCES `abertura_caixa` (`id_caixa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `vendas`
--
ALTER TABLE `vendas`
  ADD CONSTRAINT `fk_vendas_1` FOREIGN KEY (`id_caixa`) REFERENCES `abertura_caixa` (`id_caixa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vendas_2` FOREIGN KEY (`cod_produto`) REFERENCES `produtos` (`id_produto`) ON DELETE NO ACTION ON UPDATE NO ACTION;
